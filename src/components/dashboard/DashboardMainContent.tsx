...
const DashboardMainContent = ({ children }: DashboardMainContentProps) => {
  ...
  if (children) {
    return (
      <div className="flex-1 bg-[#12141a] p-6 md:p-12 relative z-10 transition-all" data-testid="admin-main">
  ...
  return (
    <div className="flex-1 bg-[#12141a] p-6 md:p-12" id="main-content" data-testid="admin-main">
