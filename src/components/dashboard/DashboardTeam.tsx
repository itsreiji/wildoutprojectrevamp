          ...
          >
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center space-x-2 text-sm text-white/70">
                ...
                <a href={`mailto:${member.email}`} className="hover:text-[#E93370] transition-colors truncate">
                  {member.email}
                </a>
              </div>
              {member.social_links?.instagram && (
                <div className="flex items-center space-x-2 text-sm text-white/70">
                  <svg className="h-4 w-4 text-[#E93370] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
