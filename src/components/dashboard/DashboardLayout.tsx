    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white">
        ...
        <motion.aside
          ...
          className="fixed top-0 left-0 h-full w-80 bg-black/40 backdrop-blur-xl border-r border-white/10 z-50 lg:translate-x-0 lg:static"
        >
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 border-b border-white/10">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={() => setSidebarOpen(false)}
                  className="lg:hidden w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
