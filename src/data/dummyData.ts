...
export const DUMMY_EVENT_ARTISTS: Database['public']['Tables']['event_artists']['Insert'][] = [
...
export const DUMMY_TEAM_MEMBERS: Database['public']['Tables']['team_members']['Insert'][] = [
  ...
  },
  {
    ...
    social_links: {
      ...
      instagram: '@michaelrodriguez_creative'
    }
  },
  {
    name: 'Aisha Patel',
    ...
    social_links: {
      ...
      instagram: '@aishapatel_marketing'
    }
  },
  {
    name: 'David Kim',
  ...
  },
  {
    ...
    social_links: {
      ...
      instagram: '@natashawilliams_social'
    }
  },
  {
    name: 'Alex Zhang',
    ...
    status: 'active',
    social_links: {
      linkedin: 'https://linkedin.com/in/alexzhang',
      instagram: '@alexzhang_partnerships'
    }
  }
];

export const DUMMY_PARTNERS: Database['public']['Tables']['partners']['Insert'][] = [
  {
    name: 'Red Bull',
